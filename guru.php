...
if(isset($_POST['tampil'])){
  $value = $_POST['show'];
$perintahQuery= "SELECT * FROM guru LIMIT $value";
$query = mysqli_query($conn,$perintahQuery);
}
...
<body>
  ...
  <div class="row mt-5 mb-4">
      <!-- tambah data -->
    <div class="col"><a href="tambah.php"><img src="img/plus.png" width="30px"> Tambah data</a></div>
...
<div id="search">
  ...
  <?php $i=1;?>
    ...
    <td><?= $row['nip']?></td>
      ...
      <td><?= $row['statuss']?></td>
      <td><?= $row['foto']?></td>
      <td><a href="editguru.php?id=<?= $row['id'];?>"><img src="img/edit.png" width="30px"></a> | <a href="guruhapus.php?id=<?= $row['id'];?>"><img src="img/hapus.png" onclick=" return confirm('Apakah anda ingin menghapus?');"width="30px"></a></td>
    </tr>
  </tbody>
  <?php $i++;?>
   <?php endwhile;?>
