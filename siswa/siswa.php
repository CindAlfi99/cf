...
<div id="search">
  ...
  <?php $i=1;?>
    ...
    <td><?= $row['nis']?></td>
      ...
      <td><?= $row['foto']?></td>
      <td><a href="editsiswa.php?id=<?= $row['id'];?>"><img src="../img/edit.png" width="30px"></a> | <a href="siswahapus.php?id=<?= $row['id'];?>"><img src="../img/hapus.png" onclick=" return confirm('Apakah anda ingin menghapus?');"width="30px"></a></td>
    </tr>
  </tbody>
  <?php $i++;?>
   <?php endwhile;?>
