...
require '../conn.php';
require '../tes.php';
$perintahQuery = "SELECT * FROM kelassiswa";
$query = mysqli_query($conn,$perintahQuery);
//tombol show
if(isset($_POST['tampil'])){
  $value = $_POST['show'];
$perintahQuery= "SELECT * FROM kelassiswa LIMIT $value";
$query = mysqli_query($conn,$perintahQuery);
}
...
<body>
  ...
  <div class="row mt-5 mb-4">
      <!-- tambah data -->
    <div class="col"><a href="klssistambah.php"><img src="../img/plus.png" width="30px"> Tambah data</a></div>
