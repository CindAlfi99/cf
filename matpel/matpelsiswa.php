...
require '../conn.php';
require '../tes.php';
$perintahQuery = "SELECT * FROM matpelsiswa";
$query = mysqli_query($conn,$perintahQuery);
//tombol show
if(isset($_POST['tampil'])){
  $value = $_POST['show'];
$perintahQuery= "SELECT * FROM matpelsiswa LIMIT $value";
$query = mysqli_query($conn,$perintahQuery);
}
...
<body>
  ...
  <div class="row mt-5 mb-4">
      <!-- tambah data -->
    <div class="col"><a href="tambahmatpel.php"><img src="../img/plus.png" width="30px"> Tambah data</a></div>
...
<div id="search">
  ...
  <?php $i=1;?>
    ...
    <td><?= $row['kode_matpel']?></td>
      ...
      <td><a href="matpeledit.php?id=<?= $row['id'];?>"><img src="../img/edit.png" width="30px"></a> | <a href="matpelhapus.php?id=<?= $row['id'];?>"><img src="../img/hapus.png" onclick=" return confirm('Apakah anda ingin menghapus?');"width="30px"></a></td>
    </tr>
  </tbody>
  <?php $i++;?>
   <?php endwhile;?>
